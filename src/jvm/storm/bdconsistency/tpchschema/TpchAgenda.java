...
public class TpchAgenda {
    ...
    public String TpchObjectConstructAndReport(String agenda) {
        ...
        availQty = Integer.valueOf(agendaAttributes[4]);
        brand = Integer.valueOf(agendaAttributes[5]);
        clerk = Integer.valueOf(agendaAttributes[6]);
        comment = Integer.valueOf(agendaAttributes[7]);
        commitDate = Integer.valueOf(agendaAttributes[8]);
        container = Integer.valueOf(agendaAttributes[9]);
        customerKey = Integer.valueOf(agendaAttributes[10]);
        discount = Float.valueOf(agendaAttributes[11]);
        extendedPrice = Float.valueOf(agendaAttributes[12]);
        lineNumber = Integer.valueOf(agendaAttributes[13]);
        lineStatus = Integer.valueOf(agendaAttributes[14]);
        mfgr = Integer.valueOf(agendaAttributes[15]);
        marketSegment = Integer.valueOf(agendaAttributes[16]);
        name = Integer.valueOf(agendaAttributes[17]);
        nationKey = Integer.valueOf(agendaAttributes[18]);
        orderDate = Integer.valueOf(agendaAttributes[19]);
        orderKey = Integer.valueOf(agendaAttributes[20]);
        orderPriority = Integer.valueOf(agendaAttributes[21]);
        orderStatus = Integer.valueOf(agendaAttributes[22]);
        partKey = Integer.valueOf(agendaAttributes[23]);
        phone = Integer.valueOf(agendaAttributes[24]);
        quantity = Float.valueOf(agendaAttributes[25]);
        receiptDate = Integer.valueOf(agendaAttributes[26]);
        regionKey = Integer.valueOf(agendaAttributes[27]);
        retailPrice = Float.valueOf(agendaAttributes[28]);
        returnFlag = Integer.valueOf(agendaAttributes[29]);
        shipDate = Integer.valueOf(agendaAttributes[30]);
        shipInstruction = Integer.valueOf(agendaAttributes[31]);
        shipMode = Integer.valueOf(agendaAttributes[32]);
        shipPriority = Integer.valueOf(agendaAttributes[33]);
        size = Integer.valueOf(agendaAttributes[34]);
        supplierKey = Integer.valueOf(agendaAttributes[35]);
        supplyCost = Float.valueOf(agendaAttributes[36]);
        tax = Float.valueOf(agendaAttributes[37]);
        totalPrice = Float.valueOf(agendaAttributes[38]);
        type = Integer.valueOf(agendaAttributes[39]);
